...
`init` prints your chart of accounts and VAT codes so you can fill in real values.
...
- **Stripe fee booked as a reverse-charged foreign service** → wrongly creates KMD lines and
  treats an exempt payment service as taxable. Book it to your bank-services expense account (e.g. 4340) with no TaxId.
